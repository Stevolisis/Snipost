      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-6 py-24 md:py-36 flex flex-col items-center">
          ...
          <div className="mt-16 w-full max-w-4xl mx-auto relative">
            <div className="aspect-video bg-black/80 rounded-xl shadow-2xl overflow-hidden border border-muted">
              {/* Placeholder for platform screenshot */}
              <div className="h-full w-full flex items-center justify-center bg-gradient-to-br from-primary/20 to-background p-5">
                <div className="text-center">
                  {/* <Code2 className="w-20 h-20 text-primary mx-auto mb-4 opacity-80" />
                  <span className="text-xl font-medium">Platform Screenshot</span> */}
                  <Image
                    src="/snipost.png"
                    alt="App Screenshot"
                    width={1000}
              ...
              <CardContent className="pt-6">
                ...
                <div className="flex items-center">
                  <div className="rounded-full overflow-hidden mr-4">
                    <Image src={testimonial.image} width={32} height={32} alt={testimonial.author} className="bg-muted" />
                  </div>
                  <div>
