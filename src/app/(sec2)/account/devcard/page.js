  ...
  return profile ? (
    <div className="flex items-center justify-center flex-col min-h-screen p-4">
      <div className="relative w-80 bg-transparent" ref={cardRef} >
        ...
        <div className="absolute inset-0 rounded-2xl p-0.5 bg-gradient-to-r from-cyan-500 via-[#A246FD] via-primary to-cyan-500 animate-pulse">
          <div className="w-full h-full bg-gray-900 rounded-2xl"></div>
        </div>
        
        {/* Main card content */}
        <div className="relative bg-gray-900 rounded-2xl p-6 m-0.5">
          {/* Header */}
